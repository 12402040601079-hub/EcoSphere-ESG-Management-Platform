...
let AdminController = class AdminController {
    ...
    async createEmissionFactor(body, req) {
        const orgId = req.user.organizationId || 'default-org-id';
...
__decorate([
    ...
    (0, roles_decorator_1.Roles)(client_1.Role.ADMIN, client_1.Role.SUPER_ADMIN, client_1.Role.MANAGER),
...
__decorate([
    (0, common_1.Post)('emission-factors'),
    ...
    __metadata("design:returntype", Promise)
], AdminController.prototype, "createEmissionFactor", null);
__decorate([
