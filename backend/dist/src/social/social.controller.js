...
__decorate([
    ...
    __metadata("design:returntype", Promise)
], SocialController.prototype, "getActivities", null);
__decorate([
    (0, common_1.Post)('log-hours'),
    (0, roles_decorator_1.Roles)(client_1.Role.EMPLOYEE, client_1.Role.MANAGER, client_1.Role.DEPARTMENT_HEAD),
    __param(0, (0, common_1.Body)()),
    __param(1, (0, common_1.Request)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object, Object]),
    __metadata("design:returntype", Promise)
], SocialController.prototype, "logHours", null);
